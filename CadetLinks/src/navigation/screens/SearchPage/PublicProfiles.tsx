...
export function PublicProfile(): React.ReactElement { // screen for showing a cadet's public profile when their search result is clicked, takes cadetKey as route param
